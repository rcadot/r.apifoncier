...
`r.apifoncier` permet d’interroger librement les **indicateurs de prix annuels et tri-annuels** produites par le Cerema à partir de DV3F. Plus de détails sur la [rubrique Datafoncier](https://datafoncier.cerema.fr/donnees/autres-donnees-foncieres/indicateurs-prix/)
...
La rubriques Exemples présente des usages de ce module : Exemples sur Indicateurs de prix
