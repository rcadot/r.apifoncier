...
`r.apifoncier` permet d’interroger librement les **mutations issues de DVF** selon le modèle de données du Cerema. Plus de détails sur [DVF+](https://datafoncier.cerema.fr/donnees/autres-donnees-foncieres/dvfplus-open-data)
