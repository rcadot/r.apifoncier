...
`r.apifoncier` permet d’interroger les **mutations issues de DV3F**, base de données enrichie sur les marchés fonciers et immobiliers du Cerema. Plus de détails sur [DV3F](https://datafoncier.cerema.fr/dv3f)
