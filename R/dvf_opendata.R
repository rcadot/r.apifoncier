...
#'
#' @return Retourne, en GeoJSON, les mutations issues de DVF+ pour la commune ou l'emprise rectangulaire demandée (paramètre code_insee ou in_bbox obligatoire)
#' @export
#'
#' @examples
#' dvf_opendata_geomutations(code_insee=59001)
dvf_opendata_geomutations <- function(
    anneemut=NULL,
    anneemut_max=NULL,
    anneemut_min=NULL,
    code_insee=NULL,
...
#' Mutations open
#'
#' @inheritParams dvf_opendata_geomutations
#'
#' @return Retourne les mutations issues de DVF+ pour la commune ou l'emprise rectangulaire demandée (paramètre code_insee ou in_bbox obligatoire)
#' @export
#'
#' @examples
#' dvf_opendata_mutations(code_insee=59001)
dvf_opendata_mutations <- function(
    anneemut=NULL,
    anneemut_max=NULL,
    anneemut_min=NULL,
    code_insee=NULL,
...
#'
#' @return Retourne la mutation pour l'identifiant de mutation demandé
#' @export
#'
#' @examples
#' dvf_opendata_mutations_idmutation(idmutation="9033720")
dvf_opendata_mutations_idmutation <- function(
    idmutation
){
